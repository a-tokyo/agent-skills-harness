...
autonomously improved via an autoresearch loop, and verified by an independent multi-agent panel.

[Get started →](/docs/io-contract) · [GitHub](https://github.com/a-tokyo/agent-skills-harness) · [Install the factory skill](https://github.com/a-tokyo/agent-skills)
