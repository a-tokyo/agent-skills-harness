...
These dimensions apply to every skill. Include all four, adjusting weights per domain.
...
Remaining weight (0.40) is allocated to domain-specific dimensions.
...
2. **Weight**: allocate from the 0.40 pool. Higher weight = more important to the domain.
